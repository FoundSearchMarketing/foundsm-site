...
```bash
bun .codex/skills/foundsm-page-builder-setup/scripts/check-page-builder-skill-setup.mjs
```
...
```bash
bun .codex/skills/foundsm-landing-page-one-shot/scripts/create-sanity-landing-page-draft.mjs <fixed-landing-page.json>
```
...
```bash
bun .codex/skills/foundsm-landing-page-one-shot/scripts/restart-local-preview-server.mjs --slug <slug> --port <port> --build
```

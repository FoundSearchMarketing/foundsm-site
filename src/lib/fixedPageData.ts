...
export const defaultCapabilityDetailPages: Record<string, CapabilityDetailPageData> = {
  ...
  performanceCreative: {
    ...
    hero: { heading: 'Make Every Interaction Count.', body: [block('Our Performance Creative and CRO teams have one goal: transform prospects into customers. We understand the impact creative can have on CPL and your bottom line.'), block("It's not just about looking good. It's about making data-based decisions that optimize your investment. Creative and landing pages are powerful levers to improve performance, drive efficiencies, and control costs.")], imageAlt: 'Performance creative sketch illustration' },
    split: { heading: 'How We Work', body: [block('At Found, Performance Creative is where strategy meets storytelling. Our Creative and CRO teams collaborate closely with Paid Media and Data Intelligence to ensure every concept, variation, and landing page is informed by real-time data and optimized for measurable results. You have a significant investment in paid media, and we optimize each touch point to reduce CPL and improve CVR. We built our team to fast-track creative and landing page production specifically for paid media campaigns.')], imageAlt: 'Performance creative workflow illustration' },
    featureTabs: { idPrefix: 'performance-creative-methods', tabs: [
      { title: 'Understanding the "Why"', body: [block('We love digging into metrics and session behavior. Heat maps, click paths, and funnel drop-off points all help us better understand your audiences, their motivations, and what moves them down the funnel.')] },
      { title: 'Agile Motion and Media Design', body: [block('No months-long VFX shoots here. We specialize in fast-tracked creative that has one goal: perform. Our team creates images, videos, and landing pages in days or hours, not weeks.')] },
      { title: 'Data-Backed Iteration', body: [block('Using innovative tools that include eye-tracking and scroll-map data, we validate creative and page tweaks in real time. Each test is measured, refined, and expanded according to results.')] },
      { title: 'Fast-Track Creative and Testing', body: [block("Found's Performance Creative Team combines inventive motion design, data-driven landing page builds, and conversion rate optimization into one workflow. We know creative sprints, and we hold brand safety and compliance to the highest standards.")] },
    ] },
    secondarySplit: { heading: 'End to End Experience Design', body: [block('Our team has a detailed understanding of landing page UX/UI and how to use it to drive action, not just get attention. By incorporating CRO best practices, compliance intelligence, and data, we build landing pages that convert.')], imageAlt: 'Creative sketch for experience design' },
    primaryCards: { cards: [

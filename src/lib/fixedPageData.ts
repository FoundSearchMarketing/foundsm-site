...
export const defaultAboutPageData: AboutPageData = {
  ...
  mission: {
    ...
    cards: [
      { title: 'Smarter', icon: '/images/pages/about-us/icon-smarter.svg', body: [block('by leveraging cutting-edge technology, first-party data, and custom methodologies to drive measurable business impact.')] },
      { title: 'Faster', icon: '/images/pages/about-us/icon-faster.svg', body: [block('by providing full-service paid media solutions, from campaign strategy and execution to high-performing ads and landing pages that convert.')] },
      { title: 'Together', icon: '/images/pages/about-us/icon-together.svg', body: [block('by sitting on the same side of the table as our clients, while empowering our team to thrive, collaborate, and grow alongside them.')] },
    ],
  },
  values: {
    heading: 'Rooted In Our Values',
    tabs: [
      { id: 'client-aligned', title: 'Client Aligned', icon: '/images/pages/about-us/icon-about-tab1.svg', image: '/images/pages/about-us/about-tab3.webp', body: [block('We are more than partners - we sit on the same side of the table. We work alongside our clients, driven by trust, shared goals, and a commitment to long-term growth.')], imageAlt: 'Client Aligned' },
      { id: 'challenge-assumptions', title: 'Challenge Assumptions', icon: '/images/pages/about-us/icon-about-tab2.svg', image: '/images/pages/about-us/about-tab2.webp', body: [block('We encourage our team, agency, and clients to question the status quo. Innovation starts with curiosity - and better outcomes come from testing, learning, and evolving together.')], imageAlt: 'Challenge Assumptions' },
      { id: 'own-outcome', title: 'Own The Outcome', icon: '/images/pages/about-us/icon-about-tab3.svg', image: '/images/pages/about-us/about-tab1.webp', body: [block('We focus on what works, measure what matters, and are committed to quality and doing things the right way for our clients - always for the growth of our team and agency.')], imageAlt: 'Own The Outcome' },
      { id: 'scale-intent', title: 'Scale With Intent', icon: '/images/pages/about-us/icon-about-tab4.svg', image: '/images/pages/about-us/about-tab4.webp', body: [block('Smart growth is shared growth. Our strategies are built to drive measurable, sustainable impact - for our clients, for our agency, and for the people who make it happen.')], imageAlt: 'Scale With Intent' },
    ],
  },
  approach: {
...
export const defaultCapabilityDetailPages: Record<string, CapabilityDetailPageData> = {
  ...
  dataIntelligence: {
    seoTitle: 'Data & Analytics | Found Search Marketing',
    ...
    canonicalUrl: 'https://foundsm.com/capabilities/data-analytics',
    ...
    primaryCards: { title: 'Your Data + Our Intelligence', subtitle: 'Let Found unlock the potential of your data.', cards: [
      { title: 'Discovery, Audit & Analysis', body: [block('The process begins by mapping your entire data landscape to get the full picture of your business. Then, we perform an in-depth analysis of your tech stack to uncover insights that drive clear recommendations and implementation plans.')], icon: '/images/pages/data-intelligence/icon-discovery.svg' },
      { title: 'Tagging & Tracking', body: [block("To ensure maximum measurement durability, our team configures the tracking and validates every event and conversion. Whether it\u2019s deploying scripts through GTM or building accurate tracking parameters back to your CRM, we\u2019ll ensure your downstream outcomes are connected to marketing data.")], icon: '/images/pages/data-intelligence/icon-tagging.svg' },
      { title: 'Engineering Audience Models', body: [block("We don\u2019t just use data to activate campaigns; we engineer high-intent audience models that uncover your most valuable customers with precision. Those audiences are activated across channels to drive efficiency, relevance and growth.")], icon: '/images/pages/data-intelligence/icon-audience.svg' },
      { title: 'Customized Solutions & Reporting', body: [block('We create customized solutions for you and your stakeholders, so each report or dashboard speaks your language and tells a clear story based on your business goals. From clicks to downstream metrics, our expertise pulls your data into one clear, powerful view.')], icon: '/images/pages/data-intelligence/icon-reporting.svg' },
      { title: 'Platform Agnostic', body: [block('We specialize in leveraging APIs that connect disparate, complex data sources into one unified view, no matter the platform or quantity of data sources. Our team is fluent across platforms, working within your existing stack to drive results.')], icon: '/images/pages/data-intelligence/icon-platform.svg' },
      { title: 'Privacy, Security & Governance', body: [block('As a certified OneTrust partner, our team has a strategic understanding of how privacy impacts your marketing. By partnering with Found, you gain a trusted advisor that will help you stay compliant, and turn privacy into a competitive advantage.')], icon: '/images/pages/data-intelligence/icon-privacy.svg' },
    ] },
    logoMarquee: { logos: [
      { image: '/images/pages/data-intelligence/logo-dynamics.svg', alt: 'Dynamics 365' },
      { image: '/images/pages/data-intelligence/logo-funnel.svg', alt: 'Funnel' },
      { image: '/images/pages/data-intelligence/logo-google-analytics.svg', alt: 'Google Analytics' },
      { image: '/images/pages/data-intelligence/logo-google-bigquery.svg', alt: 'Google BigQuery' },
      { image: '/images/pages/data-intelligence/logo-looker.svg', alt: 'Looker' },
      { image: '/images/pages/data-intelligence/logo-onetrust.svg', alt: 'OneTrust' },
      { image: '/images/pages/data-intelligence/logo-google-marketing-platform.svg', alt: 'Google Marketing Platform Certified' },
      { image: '/images/pages/data-intelligence/logo-salesforce.svg', alt: 'Salesforce' },
      { image: '/images/pages/data-intelligence/logo-vertex-ai.svg', alt: 'Vertex AI' },
      { image: '/images/pages/data-intelligence/logo-vertex-ai-icon.svg', alt: 'Vertex AI' },
      { image: '/images/pages/data-intelligence/logo-google-cloud-partner.svg', alt: 'Google Cloud Partner' },
    ] },
    secondarySplit: { heading: 'Getting the Most From Advanced Analytics & AI', body: [block('We go beyond dashboards, leveraging a variety of tools to:')], image: '/images/pages/data-intelligence/ai-chip-sm.webp', imageAlt: '' },
    secondaryCards: { cards: [
      { title: 'Detect anomalies', body: [block('in real time, enabling rapid media adjustments.')] },
      { title: 'Run predictive models', body: [block('for customer behavior.')] },
      { title: 'Perform causality analysis', body: [block('that pinpoints which tactics are getting the best results.')] },
      { title: 'Prove ROI,', body: [block('tying marketing performance directly to business outcomes.')] },
    ] },
  ...
  performanceCreative: {
    ...
    seoDescription: 'Found’s Performance Creative and CRO teams pair fast-track creative with data-backed testing to turn paid media clicks into conversions and customers.',

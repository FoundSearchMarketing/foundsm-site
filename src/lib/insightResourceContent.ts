import { legacyUploadAsset } from './legacyAssets';
...
const blogCards: InsightResourceCard[] = [
  {
    ...
    image: legacyUploadAsset('2026/03/bot-traffic-sm-850x500.webp'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2026/03/GA-API-update-hero-850x500.webp'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2026/02/Untitled-1200-x-801-px-850x500.webp'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2026/02/dataengine-850x500.webp'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2026/02/ICDPA-blog-feature-850x500.webp'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2026/01/closing-the-loop-main-850x500.webp'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2026/01/img_0446-850x500.jpg'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2025/12/GA4-Blog-image-850x500.png'),
  ...
  },
  {
    ...
    image: legacyUploadAsset('2025/11/PXL_20251105_210949084-850x500.webp?ver=1773767518'),
...
const archivePages: InsightArchivePage[] = [
  {
    ...
    ogImage: legacyUploadAsset('2026/03/blog_insights_header_images.webp'),
    ...
    heroImage: legacyUploadAsset('2026/03/blog_insights_header_images.webp'),
  ...
  },
  {
    ...
    ogImage: legacyUploadAsset('2026/03/tools_insights_header_images.webp'),
  ...
  },
  {
    ...
    ogImage: legacyUploadAsset('2026/03/play_insights_header_images.webp'),
    ...
    heroImage: legacyUploadAsset('2026/03/play_insights_header_images.webp'),
    ...
    cards: [
      {
        ...
        image: legacyUploadAsset('2026/03/manvsmachine-smx-feature-850x500.webp'),
      ...
      },
      {
        ...
        image: legacyUploadAsset('2026/02/infotrust-webinar-formheader-postevent-1-850x500.webp'),
        dateLabel: 'March 6, 2026',
        datetime: '2026-03-06',
  ...
  },
  {
    ...
    ogImage: legacyUploadAsset('2026/03/whitepapers_insights_header_images.webp'),
    ...
    heroImage: legacyUploadAsset('2026/03/whitepapers_insights_header_images.webp'),
...
const resourcePages: InsightResourcePage[] = [
  ...archivePages,
  {
    ...
    ogImage: legacyUploadAsset('2026/02/infotrust-webinar-formheader-postevent-1.webp'),
    heroTitle: 'Modernize Your Data Architecture',
    kicker: 'On-Demand Webinar',
    actionText: 'Watch Now',
    formHeading: 'Unlock the Webinar',
    heroImage: legacyUploadAsset('2026/02/infotrust-webinar-formheader-postevent-1-1024x576.webp'),
    heroImageAlt: '',
  ...
  },
  {
    ...
    ogImage: legacyUploadAsset('2026/02/infotrust-webinar-formheader-4.webp'),
    heroTitle: 'Modernizing Your Data Architecture for Successful Paid Media ROI',
    formHeading: 'Register Now',
    heroImage: legacyUploadAsset('2026/02/infotrust-webinar-formheader-4-1024x640.webp'),
    heroImageAlt: '',
  ...
  },
  {
    ...
    ogImage: legacyUploadAsset('2026/03/manvsmachine-smx-feature.webp'),
  ...
  },
  {
    ...
    ogImage: legacyUploadAsset('2026/03/cookie-chat-sm.webp'),

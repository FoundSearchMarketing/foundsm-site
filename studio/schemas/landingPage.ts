  ...
  fields: [
    ...
    defineField({
      ...
      of: [
        ...
        defineArrayMember({ type: 'proofMosaicBlock' }),
        defineArrayMember({ type: 'formLandingBlock' }),
        defineArrayMember({ type: 'accordionBlock' }),
        defineArrayMember({ type: 'peopleGridBlock' }),
        defineArrayMember({ type: 'eventHeroBlock' }),
